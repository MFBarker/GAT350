...
namespace neu
{
	...
	void CameraController::Update()
	{
		...
		if (g_inputSystem.GetKeyState(key_plus) == InputSystem::KeyState::Held)	direction.z += 1;
		if (g_inputSystem.GetKeyState(key_minus) == InputSystem::KeyState::Held)	direction.z -= 1;
