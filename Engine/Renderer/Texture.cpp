...
namespace neu
{
    ...
    bool Texture::Load(const std::string& filename)
    {
        ...
        glTexParameteri(m_target, GL_TEXTURE_MIN_FILTER, GL_LINEAR); //GL_LINEAR GL_NEAREST
        glTexParameteri(m_target, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
        glTexParameteri(m_target, GL_TEXTURE_WRAP_S, GL_REPEAT);//GL_CLAMP GL_MIRRORED_REPEAT GL_REPEAT
